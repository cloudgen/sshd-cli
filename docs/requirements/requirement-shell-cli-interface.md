...
| **Version SSOT** | `VERSION` default `1.18.0` (script header / config block: `VERSION="1.18.0"`) |
...
**Last Updated**: 2026-09-12 (1.14.0: `ssh` + `download` Host-pick verbs; TTY menu numbers ssh/download)  
