...
**Updated:** 2026-09-06 (human-readable leads; coverage maps honest; product 1.4.1)
...
| requirement-shell-interactive-vs-noninteractive | Interactive vs non-interactive / `curl\|sh` behavior | shell | Active | `requirement-shell-interactive-vs-noninteractive.md` | 2026-09-05 |
...
| requirement-domain-sshd | OpenSSH sshd domain (status/start/stop/port/keys/menu; Termux pkg names) | domain | Active | `requirement-domain-sshd.md` | 2026-09-05 |
