...
**Updated:** 2026-09-08 (dns as Termux / identity / Old OpenSSH; product 1.8.0)
...
| requirement-shell-cli-interface | Shell CLI interface (commands, flags, dispatch, modes; `wake-lock`) | shell | Active | `requirement-shell-cli-interface.md` | 2026-09-08 |
...
| requirement-domain-sshd | OpenSSH sshd domain (status/start/stop/port/keys/menu/dns; background daemon; Termux wake lock on start; this-login ssh_config dns-ip; as Termux / identity / Old OpenSSH; menu row 5) | domain | Active | `requirement-domain-sshd.md` | 2026-09-08 |
